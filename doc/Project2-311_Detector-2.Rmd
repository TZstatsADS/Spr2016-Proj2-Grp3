...
Anomaly_Detector = function(DataFrame_Total, Top.Complaints.Day, Compliant_Input){
  ...
  #Apply Detection
  res = AnomalyDetectionTs(DataFrame_Filtered2, max_anoms=0.02, direction='pos', plot=TRUE,piecewise_median_period_weeks = 2)
  res$plot
